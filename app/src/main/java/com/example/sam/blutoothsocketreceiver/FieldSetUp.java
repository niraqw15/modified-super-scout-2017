...
public class FieldSetUp extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseUrl = intent.getExtras().getString("dataBaseUrl"); //TODO: Check if this is in the intent extras in MainActivity
        isMute = intent.getExtras().getBoolean("mute");

        firebaseRef = new Firebase(dataBaseUrl); //TODO: Something seems to be wrong here (probably with the old firebase)
        ...
        //Important: create the 4 by 7 of buttons
        for (int i = 0; i < 4; i++) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nextButton) {
            Intent next = new Intent(this, ScoutingPage.class); //Note that this doesn't need to be changed, as it already points to the correct activity.
